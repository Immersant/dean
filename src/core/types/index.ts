...
export {
  ...
  type ExecutionInputCanvasNodeSnapshot,
  type ExecutionInputCanvasSnapshot,
  type ExecutionInputContextSnapshot,
  type ExecutionInputConversationBindingSnapshot,
  type ExecutionInputCurrentNoteSnapshot,
  type ExecutionInputCursorSnapshot,
  type ExecutionInputEditorSnapshot,
  type ExecutionInputSessionSectionAnswers,
  type ExecutionInputSessionSectionQuestionOptionSnapshot,
  type ExecutionInputSessionSectionQuestionSnapshot,
  type ExecutionInputSessionSectionSnapshot,
