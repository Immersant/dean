...
function clickButton(root: any, text: string): void {
  const buttons = findAllByClass(root, 'dean-instruction-btn');
...
describe('InstructionModal', () => {
  describe('onOpen', () => {
    it('renders the raw instruction text', () => {
      ...
      const originalEl = findByClass(contentEl, 'dean-instruction-original');
    ...
    it('starts in loading state', () => {
      ...
      const loadingEl = findByClass(contentEl, 'dean-instruction-loading');
      expect(loadingEl).not.toBeNull();
      expect(loadingEl.hasClass('dean-hidden')).toBe(false);

      const clarificationEl = findByClass(contentEl, 'dean-instruction-clarification-section');
      expect(clarificationEl.hasClass('dean-hidden')).toBe(true);

      const confirmationEl = findByClass(contentEl, 'dean-instruction-confirmation-section');
      expect(confirmationEl.hasClass('dean-hidden')).toBe(true);
    });
    ...
    it('renders Cancel button in loading state', () => {
      ...
      const buttons = findAllByClass(contentEl, 'dean-instruction-btn');
  ...
  describe('showClarification', () => {
    it('transitions to clarification state', () => {
      ...
      const loadingEl = findByClass(contentEl, 'dean-instruction-loading');
      expect(loadingEl.hasClass('dean-hidden')).toBe(true);

      const clarificationEl = findByClass(contentEl, 'dean-instruction-clarification-section');
      expect(clarificationEl.hasClass('dean-hidden')).toBe(false);
    });
    ...
    it('displays the clarification text', () => {
      ...
      const clarificationTextEl = findByClass(contentEl, 'dean-instruction-clarification');
  ...
  describe('showConfirmation', () => {
    it('transitions to confirmation state', () => {
      ...
      const confirmationEl = findByClass(contentEl, 'dean-instruction-confirmation-section');
      expect(confirmationEl.hasClass('dean-hidden')).toBe(false);
    });
    ...
    it('displays the refined instruction', () => {
      ...
      const refinedEl = findByClass(contentEl, 'dean-instruction-refined');
