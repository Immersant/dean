...
describe('WriteEditRenderer', () => {
  describe('createWriteEditBlock', () => {
    ...
    it('should start collapsed by default', () => {
      ...
      expect(state.contentEl.hasClass('dean-hidden')).toBe(true);
    ...
    it('should start expanded when requested', () => {
      ...
      expect(state.contentEl.hasClass('dean-hidden')).toBe(false);
  ...
  describe('renderStoredWriteEdit', () => {
    ...
    it('should start collapsed by default', () => {
      ...
      const block = renderStoredWriteEdit(parentEl, toolCall);
      const headerEl = block.querySelector('.dean-write-edit-header');
      const contentEl = block.querySelector('.dean-write-edit-content');
